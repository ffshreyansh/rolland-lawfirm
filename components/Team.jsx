  ...
  return (
    <div className='font-inter mt-20'>
      <div className='flex flex-col justify-center px-20'>
        <span className='text-8xl font-medium flex items-center gap-4'>
          MEET THE
          <span className='h-2 w-20 bg-black'></span>
        ...
        <span className='text-8xl font-medium ml-auto'>ROLLAND TEAM</span>
      </div>
      <div className='vContain w-full h-fit mt-20 relative'>
        ...
        <span className='absolute font-bold rolland left-1/2 transform -translate-x-1/2 '>ROLLAND</span>
      </div>
