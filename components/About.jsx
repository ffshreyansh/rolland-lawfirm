...
const About = () => {
  ...
  return (
    <div className='flex flex-col lg:flex lg:flex-row lg:items-start justify-between mt-16 lg:py-24 lg:pb-10 font-inter px-6'>
      ...
      <div className='w-full mt-10 lg:mt-0 lg:w-3/4 '>
        ...
        <div className='flex flex-col lg:flex-row lg:items-center justify-between h-fit mt-14 lg:mt-28'>
